...
import { View, Text, TextInput, TouchableOpacity, StatusBar, Alert, KeyboardAvoidingView, Platform, ScrollView, Keyboard, TouchableWithoutFeedback, Image, ActivityIndicator } from 'react-native';
import { getCreateDepositStyles } from '../../styles/groups/createDepositStyles';
...
const CreateDepositScreen = ({ navigation, route }) => {
  ...
  const styles = useMemo(() => getCreateDepositStyles(colors), [colors]);
